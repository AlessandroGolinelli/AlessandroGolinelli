...
|---|---|---|
| 🩺 Breast Cancer Classifier | Automatic classification web app | YOLO, ResNet |
| 🚁 Drone Landing | Image semantic segmentation for autonomous landing | Deep Learning |
| 🌾 PRISMA Mission | Hyperspectral analysis for crop optimization | Python, ML |
| 🎸 Poly-tuner Pedal | MLP-driven guitar tuner pedal | Arduino, Raspberry Pi |
